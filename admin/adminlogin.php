...
if(isset($_POST['masuk'])){
    ...
    $sql_login ="select * from admin where no_matrik='$s_number' and admin_pswd='$password'";
	...
	$j=$r['type'];
		...
		echo "window.location.href='../admin/adminlogin.php?failed';";
  	    echo "</script>";

         }elseif($_POST['username']==$s_number && $r['type']=="Admin"){
		...
		$_SESSION['type'] = $j;
   		...
   		header("Location: http://localhost/SPAUS/admin/admin.php");
...
<div class="wrap">
   ...
   <header>
      <div class="container">
         <h1><a href="../home/index.php">Student's site</a></h1>
         <nav>
            <ul>
   ...
   <div class="container">
      ...
      <!-- content -->
         ...
         <div class="inside">
            <h2>DAFTAR MASUK PENTADBIR<span></span></h2>
            <br>
            <br>
	...
	<form method="post" action="adminlogin.php">
    	<table>
            ...
            <tr>
                <td></td>
                <td><input type="submit" value="Masuk" name="masuk"></td>
           </table>
