   ...
   <div class="container">
      ...
      <aside>
         ...
         <ul class="categories">
            ...
            <li><span><a href="../presskit/pressreleasehome.php" class="active">Senarai Permohonan Press Kit</a></span></li>
...
<?php
                          $sql_get_lec= "SELECT * FROM siaran_akhbar;";
...
while (($q = mysqli_fetch_array($result_get_lec,MYSQLI_ASSOC)) !==NULL) 
{
	...
	echo "<td style=text-align:center;>".$q{'disediakan'}."</td>";
	echo "<td style=text-align:center;>".$q{'contact_no'}."</td>";
	echo "<td style=text-align:center;><a href='pressreport.php?id=".$q{'idrelease'}."'<button>Paparkan</button></a></td>";
	echo "<td style=text-align:center;><a href='../../PHPWord/test.php?id=".$q{'idrelease'}."'><button>Muat turun dokumen</button></a></td>";
