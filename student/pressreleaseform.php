...
<div class="wrap">
  ...
  <tr>
   ...
   <td> <textarea name="tajuk" cols="70" rows="3">
   ...
   <tr>
   <td> <h4>Anjuran:</h4></td>
   <td> <textarea name="anjuran" cols="70" rows="3">
   ...
   <td> <textarea name="kerjasama" cols="70" rows="3">
   ...
   <td> <textarea name="sinopsis" cols="70" rows="5">
   ...
   <td> <textarea name="objektif" cols="70" rows="5">
   ...
   <tr>
   <td> <h4>Sasaran:</h4></td>
   <td> <textarea name="sasaran" cols="70" rows="5">
   ...
   <td> <textarea name="tentatif" cols="70" rows="8">
   ...
   <td> <textarea name="perasmi" cols="70" rows="3">
   ...
   <td> <textarea name="vip" cols="70" rows="5">
   ...
   <td> <textarea name="disediakan" cols="70" rows="2">
   ...
   <td> <textarea name="pegawai" cols="70" rows="2">
   ...
   <tr>
   <td></td>
   <td><input type="submit" name="press" value="Hantar">
    
    </table>
    </form>
<?php
include("submitpress.php");
